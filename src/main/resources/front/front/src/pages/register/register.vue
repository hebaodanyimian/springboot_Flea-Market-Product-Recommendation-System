	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于协同过滤算法的跳蚤市场商品推荐系统</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='shangjia'" prop="shangjiamingcheng">
						<div class="label" :class="changeRules('shangjiamingcheng')?'required':''">商家名称：</div>
					...
					<el-form-item class="list-item" v-if="tableName=='shangjia'" prop="lianxifangshi">
