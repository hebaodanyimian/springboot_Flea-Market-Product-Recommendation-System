<template>
	<div class="menu-preview">
		...
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","flexWrap":"wrap","background":"none","display":"flex","gap":"12px","position":"relative"}' mode="horizontal" class="el-menu-horizontal-2">
		    <el-menu-item class="home" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","backgroundColor":"transparent","color":"#333","float":"left"}' @click.native="menuHandler('')" index="/">
				<div class="el-tooltip">
					<i :style='{"verticalAlign":"middle","margin":"0 7px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="icon iconfont icon-shouye-zhihui"></i>
					<span :style='{"verticalAlign":"middle","padding":"0 0 0 20px","fontSize":"14px","color":"inherit"}' slot="title">系统首页</span>
				</div>
			</el-menu-item>
		    <el-submenu class="user" popper-class="user" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","backgroundColor":"transparent","color":"#333","float":"left"}' index="1">
				<template slot="title">
					<i :style='{"verticalAlign":"middle","margin":"0 7px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="icon iconfont icon-kuaijiezhifu"></i>
					<span :style='{"verticalAlign":"middle","padding":"0 0 0 20px","fontSize":"14px","color":"inherit"}' slot="title">个人中心</span>
				</template>
			...
			<template v-for="(menu,index) in menuList.backMenu" v-if="menu.child.length&&menu.child[0].tableName!='hasBoard'">
				<el-submenu v-if="menu.child.length > 1 || !horizontalIsMultiple" class="other" popper-class="other" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","backgroundColor":"transparent","color":"#333","float":"left"}' :index="index+2+''">
					<template slot="title">
						<i :style='{"verticalAlign":"middle","margin":"0 7px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]"></i>
						<span :style='{"verticalAlign":"middle","padding":"0 0 0 20px","fontSize":"14px","color":"inherit"}' slot="title">{{menu.menu + (horizontalFlag ? '管理' : '')}}</span>
					</template>
				...
				<el-menu-item v-if="menu.child.length <= 1 && horizontalIsMultiple" class="other" popper-class="other" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","backgroundColor":"transparent","color":"#333","float":"left"}' @click="menuHandler(menu.child[0].tableName)" :index="'/'+menu.child[0].tableName">
					<div class="el-tooltip">
						<i :style='{"verticalAlign":"middle","margin":"0 7px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]"></i>
						<span :style='{"verticalAlign":"middle","padding":"0 0 0 20px","fontSize":"14px","color":"inherit"}' slot="title">{{menu.child[0].menu + (horizontalFlag ? '管理' : '')}}</span>
					</div>
				</el-menu-item>
			</template>
		</el-menu>
...
// 			// }
	...
	.el-menu-horizontal-2>.el-menu-item.other>.el-tooltip {
		...
		color: #000;
		white-space: nowrap;
		background: url(http://codegen.caihongy.cn/20241008/0cacf949451a424f8acb36c998945ec3.png) no-repeat;
		font-size: 16px;
		line-height: 60px;
		list-style: none;
		height: 60px;
	...
	.el-menu-horizontal-2>.el-menu-item.other>.el-tooltip:hover {
		border: 0;
		color: #000;
		background: url(http://codegen.caihongy.cn/20241008/c1ee3f10fcda4423bfcafc2f71ca9def.png) no-repeat;
	}
